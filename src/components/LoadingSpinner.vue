    ...
    <div class="loadingSpinner__shapeContainer">
      ...
      <div v-else-if="shapeIndex === 4">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="m1 23.85c0 11.15 20 20.35 46.35 22.31-26.35 1.96-46.35 11.21-46.35 22.32s20 20.36 46.35 22.32c-26.35 1.95-46.35 11.2-46.35 22.31 0 12.54 25.42 22.7 56.79 22.7s56.8-10.16 56.8-22.7c0-11.11-20-20.36-46.36-22.31 26.38-2 46.36-11.21 46.36-22.32s-20-20.36-46.36-22.32c26.38-2 46.36-11.2 46.36-22.31 0-12.54-25.43-22.71-56.8-22.71s-56.79 10.17-56.79 22.71z" stroke-linejoin="round"/>
        </svg>
      </div>
